...
MapQuickItem {
    ...
    sourceItem: Item {
            ...
            Item {
                ...
                Canvas {
                    ...
                    function paintHeading() {
                        ...
                        context.clearRect(0, 0, targetIcon.width, targetIcon.height);
        ...
        DropShadow {
            ...
            visible:            targetIcon.visible && _adsbVehicle
            horizontalOffset:   4
            verticalOffset:     4
            radius:             32.0
            samples:            65
        ...
        Image {
            ...
            source:             "/qmlimages/myLocations.svg"
            mipmap:             true
            width:              _root.size
            sourceSize.width:   _root.size
            fillMode:           Image.PreserveAspectFit
            transform: Rotation {
                origin.x:       targetIcon.width  / 2
                origin.y:       targetIcon.height / 2
